...
public class UICamera : MonoBehaviour
{
	...
	public void ProcessTouch (bool pressed, bool unpressed)
	{
		...
		UICamera cam = this;
		if(currentTouch.pressedCam != null)
		{
			UICamera c =  currentTouch.pressedCam.GetComponent<UICamera>();
			if(c != null)
			{
				cam = c;
			}
		...
		float drag   = isMouse ? cam.mouseDragThreshold : cam.touchDragThreshold;
		float click  = isMouse ? cam.mouseClickThreshold : cam.touchClickThreshold;
