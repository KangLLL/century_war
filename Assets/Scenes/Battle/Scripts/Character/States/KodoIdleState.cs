...
public class KodoIdleState : CharacterIdleState 
{
	...
	public KodoIdleState(NewAI aiBehavior, bool isFindInstantly) : base(aiBehavior, isFindInstantly)
	{
		this.m_StateName = "KodoIdle";
	}
		...
		else
		{
			...
			else
			{
				...
				if(target != null)
				{
					...
					if(property != null)
					//if(property != null && property.BuildingType == BuildingType.Wall)
					{
						...
						if(targetBuilding != null)
						{
							...
							if(property != null)
							{
								...
								KodoWalkState walkState = new KodoWalkState(this.CharacterAI.BattleMapData, endPoint, this.m_AIBehavior, targetBuilding);
