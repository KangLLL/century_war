...
public class IntroUpgradeBarracks : NewbieGuide
{
    public override void OnIntroUpgradeBarracks()
    {
        if (LogicController.Instance.GetBuildingCount(BuildingType.Barracks) != 1 || !base.ConditionExistBuildingLevel(BuildingType.Barracks, 1) || !base.ConditionExistBuildingState(BuildingType.Barracks, BuildingEditorState.Normal))
        {
        ...
        NewbieGuideManager.Instance.UIWindowGuide.SetWindowItem(StringConstants.NEWBIEGUIDE_CONTEXT[13.1f]);
    ...
    public override void OnUpgradeBarracks()
    {
        if (LogicController.Instance.GetBuildingCount(BuildingType.Barracks) != 1 || !base.ConditionExistBuildingLevel(BuildingType.Barracks, 1) || base.ConditionExistBuildingState(BuildingType.Barracks, BuildingEditorState.Normal))
        {
            NewbieGuideManager.Instance.InvokeNextGuide();
            ...
            dynamicInvokeGuide.Click += () =>
            {
                ...
                dynamicInvokeGuide.Click += () =>
                {
                    ...
                    NewbieGuideManager.Instance.Waiting(90, () =>
                    {
                        ...
                        NewbieGuideManager.Instance.UIWindowGuide.SetWindowItem(StringConstants.NEWBIEGUIDE_CONTEXT[13.2f]);
                        NewbieGuideManager.Instance.UIWindowGuide.ShowWindow(UIAnchor.Side.Center, true);
